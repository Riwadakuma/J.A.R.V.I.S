"""Shared stylist utilities used by CLI and controller."""
...
class _SafeDict(dict):
    def __missing__(self, key: str) -> str:  # pragma: no cover - passthrough
        return "{" + key + "}"
...
_default_stylist = Stylist(templates_path=Path(__file__).parent / "templates.yaml")
